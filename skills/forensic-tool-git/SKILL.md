---
name: forensic-tool-git
description: Use git in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Inspect or retrieve repositories relevant to a case.
---
...
```bash
tools/run-forensic-tool.sh git [args...]
```

Do not leak credentials. Example: `tools/run-forensic-tool.sh git log --oneline -20`.
