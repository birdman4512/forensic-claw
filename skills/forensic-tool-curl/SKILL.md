---
name: forensic-tool-curl
description: Use curl in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Make HTTP requests for evidence retrieval or header checks.
---
...
```bash
tools/run-forensic-tool.sh curl [args...]
```

Prefer read-only GET/HEAD. Example: `tools/run-forensic-tool.sh curl -I https://example.com`.
