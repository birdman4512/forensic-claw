---
name: forensic-tool-file
description: Use file in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Identify file types and basic artefact signatures during triage.
---
...
```bash
tools/run-forensic-tool.sh file [args...]
```

Run before deeper parsing. Example: `tools/run-forensic-tool.sh file /home/node/.openclaw/cases/<case-id>/evidence/artifact`.
