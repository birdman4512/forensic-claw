---
name: forensic-tool-lshw
description: Use lshw in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Collect host hardware inventory when analyzing a live/triage host.
---
...
```bash
tools/run-forensic-tool.sh lshw [args...]
```

Use only on authorized systems or captured environments. Example: `tools/run-forensic-tool.sh lshw -short`.
