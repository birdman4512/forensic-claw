---
name: forensic-tool-rg
description: Use rg in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Search text logs, configs, and extracted artefacts.
---
...
```bash
tools/run-forensic-tool.sh rg [args...]
```

Use for local evidence review. Example: `tools/run-forensic-tool.sh rg -n -i "failed|error|admin" /home/node/.openclaw/cases/<case-id>/evidence/logs`.
