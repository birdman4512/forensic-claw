---
name: forensic-tool-traceroute
description: Use traceroute in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Check network path diagnostics during incident triage.
---

# forensic-tool-traceroute
...
```bash
tools/run-forensic-tool.sh traceroute [args...]
```

Treat as indicative only. Example: `tools/run-forensic-tool.sh traceroute <host>`.
