---
name: forensic-tool-testdisk
description: Use testdisk in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Perform partition/recovery triage on disk images.
---
...
```bash
tools/run-forensic-tool.sh testdisk [args...]
```

Prefer non-interactive/reporting where possible. Do not write recovered data over original evidence.
