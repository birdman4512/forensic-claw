---
name: forensic-tool-nmap
description: Use nmap in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Perform authorized network/service checks in incident triage.
---
...
```bash
tools/run-forensic-tool.sh nmap [args...]
```

Confirm scope first. Prefer low-impact scans. Example: `tools/run-forensic-tool.sh nmap -sV -Pn -T2 <target>`.
