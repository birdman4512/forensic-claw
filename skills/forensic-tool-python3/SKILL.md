---
name: forensic-tool-python3
description: Use python3 in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Run small forensic parsing or reporting scripts.
---

# forensic-tool-python3
...
```bash
tools/run-forensic-tool.sh python3 [args...]
```

Prefer checked-in scripts for repeatable logic. Example: `tools/run-forensic-tool.sh python3 scripts/parse.py`.
