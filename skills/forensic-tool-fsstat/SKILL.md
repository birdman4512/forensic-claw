---
name: forensic-tool-fsstat
description: Use fsstat in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Summarize filesystem metadata from disk images.
---

# forensic-tool-fsstat
...
```bash
tools/run-forensic-tool.sh fsstat [args...]
```

Use to confirm filesystem type and metadata before extraction. Example: `tools/run-forensic-tool.sh fsstat -o <offset> image.dd`.
