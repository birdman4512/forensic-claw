---
name: forensic-tool-dig
description: Use dig in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Query DNS records during intrusion or infrastructure analysis.
---
...
```bash
tools/run-forensic-tool.sh dig [args...]
```

Record resolver and query type. Example: `tools/run-forensic-tool.sh dig A example.com +short`.
