---
name: forensic-tool-jq
description: Use jq in Forensic Claw for lawful DFIR, cyber security, evidence triage, intrusion analysis, and case-backed forensic workflows. Parse JSON logs and tool outputs.
---
...
```bash
tools/run-forensic-tool.sh jq [args...]
```

Use deterministic filters and save outputs. Example: `tools/run-forensic-tool.sh jq -r . file.json`.
